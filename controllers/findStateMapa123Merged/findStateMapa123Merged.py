...
dataset = pd.read_csv('mapa123.csv')
...
s1 = statistics.mode(kmeans.labels_[0:2999])
s2 = statistics.mode(kmeans.labels_[3000:5999])
s3 = statistics.mode(kmeans.labels_[6000:8999])
s4 = statistics.mode(kmeans.labels_[9000:11999])
s5 = statistics.mode(kmeans.labels_[12000:14999])
s6 = statistics.mode(kmeans.labels_[15000:17999])
s7 = statistics.mode(kmeans.labels_[18000:20999])
